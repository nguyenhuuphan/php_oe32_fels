        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="course_container">
                    <div class="course_title">@lang('common.policy')</div>
                    
                    <!-- Course Image -->
                    <div class="course_image"><img src="{{ asset('images/policy.jpg')}}" alt=""></div>
                    
                    <!-- Course Tabs -->
                    <div class="course_tabs_container">
                        <div class="tab_panels">
                            <div class="tab_panel active">
                                <div class="tab_panel_title">@lang('common.policy')</div>
